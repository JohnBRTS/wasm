...
let Porcupine = function() {
  ...
  let create = function(keywordIDs, sensitivities) {
     ...
     */
    let keywordIDSizes = Int32Array.from(
      keywordIDs.map(keywordID => keywordID.byteLength)
    );
    let keywordIDSizesPointer = porcupineModule._malloc(
      keywordIDSizes.byteLength
    );
    let keywordIDSizesBuffer = new Uint8Array(
    ...
    let keywordIDPointers = Uint32Array.from(
    ...
    let keywordIDPointersPointer = porcupineModule._malloc(
